...
@section('viewdistrict')
    active-link
@endsection

@section('for_viewdistrict')
    active
@endsection
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href=" {{ url('/edit-district/'.$proid) }} " class="btn btn-sm" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
